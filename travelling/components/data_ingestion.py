...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            #for train_index,test_index in split.split(travel_data_frame,travel_data_frame["default.payment.next.month"]):
                #strat_train_set = travel_data_frame.loc[train_index].drop(["ID"],axis=1)
                #strat_test_set = travel_data_frame.loc[test_index].drop(["ID"],axis=1)
